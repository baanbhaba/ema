    ...
    <div className="min-h-screen bg-[#f8f6f0] dark:bg-[#0d1117] text-[#181c24] dark:text-[#f0f6fc] flex flex-col font-sans transition-colors relative">
      ...
      >
        {notifications.map((n) => (
          <div
            key={n.id}
            className={`pointer-events-auto p-3.5 border-2 border-[#181c24] dark:border-[#30363d] shadow-[3px_3px_0px_#181c24] dark:shadow-[3px_3px_0px_#010409] flex items-start justify-between space-x-3 transition-all ${
              n.type === "success"
